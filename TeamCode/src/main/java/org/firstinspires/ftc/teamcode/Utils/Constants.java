...
public class Constants {
    public static final int ENCODER_TICKS_PER_ROTATION_20 = 560;
    ...
    public class Teleop {
        public static final int LINEAR_SLIDE_INCREMENT = ENCODER_TICKS_PER_ROTATION_60 / 4;//Increment 1/2 rotation per press
        ...
        public static final double FORKLIFT_HOLD_POSITION = 0.3;
    ...
    public class Robot {
        ...
        public static final int MOTOR_ENCODERS_USED = Constants.ENCODER_TICKS_PER_ROTATION_20;
