...
public class Constants {
    ...
    public static final int LINEAR_SLIDE_INCREMENT = ENCODER_TICKS_PER_ROTATION;//Increment 1 rotation per press
    public static final int LINEAR_SLIDE_UP = ENCODER_TICKS_PER_ROTATION * 10;//Start with 10 rotations
