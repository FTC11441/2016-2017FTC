...
public class Constants {
    public static final int ENCODER_TICKS_PER_ROTATION_40 = 1120;//1560;
    ...
    public class Teleop {
        public static final int LINEAR_SLIDE_INCREMENT = ENCODER_TICKS_PER_ROTATION_40;//Increment 1 rotation per press
        public static final int LINEAR_SLIDE_UP = ENCODER_TICKS_PER_ROTATION_40 * 10;//Start with 10 rotations
